...
def load_langpair_dataset(
    ...
    for k in itertools.count():
        ...
        # src_graph = data_utils.load_sp_graph(prefix + src)
        src_img_features = data_utils.load_img_features(prefix + src)
...
class TranslationTask(FairseqTask):
    ...
    def valid_step(self, sample, model, model_nmt,criterion):
        loss, sample_size, logging_output = super().valid_step(sample, model, model_nmt,criterion)
