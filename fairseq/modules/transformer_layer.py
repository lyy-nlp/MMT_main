...
class TransformerEncoderLayer(nn.Module):
    ...
    *args.encoder_normalize_before* to ``True``.
    ...
    def __init__(self, args):
        ...
        self.swap_num = getattr(args, "swap_num", 4)
    ...
    def forward(self, x, src_img_features, noisy_src_img_features,encoder_padding_mask, encoder_padding_mask_image, batch_len,idx,mask_matrix_tmp,
        ...
        ####################################
        ########  image encoder  ###########
        src_img_features= self.image_encoder(idx, src_img_features, encoder_padding_mask_image,
                                              mask_matrix_tmp)
        noisy_src_img_features = self.image_encoder(idx, noisy_src_img_features, encoder_padding_mask_image,
                                              mask_matrix_tmp)
        ...
        return x,src_img_features,noisy_src_img_features
...
class TransformerEncoderLayer_image(nn.Module):
    ...
    *args.encoder_normalize_before* to ``True``.
    ...
    def forward(self, lay_idx, src_img_features, encoder_padding_mask, mask_matrix_tmp,
        ...
        x_numpy = np.around(x_numpy, decimals=5)
        # gate_numpy = gate_numpy * 28
        np.save('/home/lyy/Gating2-fairseq-inter2/attention/x_2.npy', x_numpy)'''
